...
public class ImageQuoteRecyclerDecoration extends RecyclerView.ItemDecoration {
    int sidePadding, topPadding,bottomPadding;

    public ImageQuoteRecyclerDecoration(int sidePadding, int topPadding, int bottomPadding) {
